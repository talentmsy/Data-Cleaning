...
load("rawDSF_directlydownloadfromCRSP.Rdata")
rawcrsp<-DSF
setDT(rawcrsp)
...
#crsp[,c("dlret","dlstdt","prc","shrout"):=NULL]
...
crsp<-unique(crsp2,by=c("permno","jdate"))
save(crsp,file="60_22_CRSP_DSF_F&Dadjusted.RData")
